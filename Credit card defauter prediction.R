...
library("caret")
  ...
  link<-paste("F:/Applied stats/project/default-of-credit-card-clients-dataset/","UCI_Credit_Card",".csv",sep="")
  
  #link to save correlation matrix output in file
  link2<-paste("F:/Applied stats/project/default-of-credit-card-clients-dataset/","cor",".csv",sep="")
